...
// oldj/SwitchHosts Apache License 2.0 minify https://github.com/oldj/SwitchHosts/blob/f595d23e1df8c52062cb12fc4a5c7a90b9e6a637/src/renderer/components/Editor/cm_hl.ts
CodeMirror.defineMode("hosts",function(){function d(a){if(a.eatSpace())return null;var b=a.sol(),c=a.next(),e=a.string;return"#"===c?(a.skipToEnd(),"comment"):e.match(/^\s*([\d.]+|[\da-f:.%lo]+)\s+\w/i)?b&&c&&c.match(/[\w.:%]/)?(a.eatWhile(/[\w.:%]/),"ip"):null:"error"}return{startState:function(){return{tokens:[]}},token:function(a,b){return(b.tokens[0]||d)(a,b)},lineComment:"#"}});
...
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/5/LICENSE
(function(u){u(CodeMirror)})(function(u){function I(a,b){this.mv=a;this.type=b;this.classes="left"==b?{chunk:"CodeMirror-merge-l-chunk",start:"CodeMirror-merge-l-chunk-start",end:"CodeMirror-merge-l-chunk-end",insert:"CodeMirror-merge-l-inserted",del:"CodeMirror-merge-l-deleted",connect:"CodeMirror-merge-l-connect"}:{chunk:"CodeMirror-merge-r-chunk",start:"CodeMirror-merge-r-chunk-start",end:"CodeMirror-merge-r-chunk-end",insert:"CodeMirror-merge-r-inserted",del:"CodeMirror-merge-r-deleted",connect:"CodeMirror-merge-r-connect"}}function F(a){a.diffOutOfDate&&(a.diff=Y(a.orig.getValue(),a.edit.getValue(),a.mv.options.ignoreWhitespace),a.chunks=Z(a.diff),a.diffOutOfDate=!1,u.signal(a.edit,"updateDiff",a.diff))}function pa(a){function b(m){J=!0;l=!1;"full"==m&&(a.svg&&K(a.svg),a.copyButtons&&K(a.copyButtons),P(a.edit,g.marked,a.classes),P(a.orig,h.marked,a.classes),g.from=g.to=h.from=h.to=0);F(a);a.showDifferences&&(aa(a.edit,a.diff,g,DIFF_INSERT,a.classes),aa(a.orig,a.diff,h,DIFF_DELETE,a.classes));"align"==a.mv.options.connect&&Q(a);D(a);null!=a.needsScrollSync&&G(a,a.needsScrollSync);J=!1}function c(m){J||(a.dealigned=!0,d(m))}function d(m){J||l||(clearTimeout(k),!0===m&&(l=!0),k=setTimeout(b,!0===m?20:250))}function e(m,p){a.diffOutOfDate||(a.diffOutOfDate=!0,g.from=g.to=h.from=h.to=0);c(p.text.length-1!=p.to.line-p.from.line)}function f(){a.diffOutOfDate=!0;a.dealigned=!0;b("full")}var g={from:0,to:0,marked:[]},h={from:0,to:0,marked:[]},k,l=!1;a.edit.on("change",e);a.orig.on("change",e);a.edit.on("swapDoc",f);a.orig.on("swapDoc",f);"align"==a.mv.options.connect&&(u.on(a.edit.state.trackAlignable,"realign",c),u.on(a.orig.state.trackAlignable,"realign",c));a.edit.on("viewportChange",function(){d(!1)});a.orig.on("viewportChange",function(){d(!1)});b();return b}function qa(a,b){a.edit.on("scroll",function(){G(a,!0)&&D(a)});a.orig.on("scroll",function(){G(a,!1)&&D(a);b&&G(b,!0)&&D(b)})}function G(a,b){if(a.diffOutOfDate)return a.lockScroll&&null==a.needsScrollSync&&(a.needsScrollSync=b),!1;a.needsScrollSync=null;if(!a.lockScroll)return!0;var c=+new Date;if(b){var d=a.edit;var e=a.orig}else d=a.orig,e=a.edit;if(d.state.scrollSetBy==a&&(d.state.scrollSetAt||0)+250>c)return!1;var f=d.getScrollInfo();if("align"==a.mv.options.connect)r=f.top;else{var g=.5*f.clientHeight;r=f.top+g;var h=d.lineAtHeight(r,"local");for(var k=a.chunks,l,m,p,v=0;v<k.length;v++){var q=k[v],w=b?q.editFrom:q.origFrom,t=b?q.editTo:q.origTo;null==m&&(w>h?(m=q.editFrom,p=q.origFrom):t>h&&(m=q.editTo,p=q.origTo));if(t<=h){l=q.editTo;var n=q.origTo}else w<=h&&(l=q.editFrom,n=q.origFrom)}h={before:l,after:m};n={before:n,after:p};d=ba(d,b?h:n);n=ba(e,b?n:h);var r=n.top-g+(r-d.top)/(d.bot-d.top)*(n.bot-n.top),x;r>f.top&&1>(x=f.top/g)?r=r*x+f.top*(1-x):(d=f.height-f.clientHeight-f.top)<g&&(n=e.getScrollInfo(),n.height-n.clientHeight-r>d&&1>(x=d/g)&&(r=r*x+(n.height-n.clientHeight-d)*(1-x)))}e.scrollTo(f.left,r);e.state.scrollSetAt=c;e.state.scrollSetBy=a;return!0}function ba(a,b){var c=b.after;null==c&&(c=a.lastLine()+1);return{top:a.heightAtLine(b.before||0,"local"),bot:a.heightAtLine(c,"local")}}function R(a,b,c){(a.lockScroll=b)&&0!=c&&G(a,DIFF_INSERT)&&D(a);(b?u.addClass:u.rmClass)(a.lockButton,"CodeMirror-merge-scrolllock-enabled")}function P(a,b,c){for(var d=0;d<b.length;++d){var e=b[d];if(e instanceof u.TextMarker)e.clear();else if(e.parent)for(var f=a,g=c,h=g.classLocation,k=0;k<h.length;k++)f.removeLineClass(e,h[k],g.chunk),f.removeLineClass(e,h[k],g.start),f.removeLineClass(e,h[k],g.end)}b.length=0}function aa(a,b,c,d,e){var f=a.getViewport();a.operation(function(){c.from==c.to||20<f.from-c.to||20<c.from-f.to?(P(a,c.marked,e),S(a,b,d,c.marked,f.from,f.to,e),c.from=f.from,c.to=f.to):(f.from<c.from&&(S(a,b,d,c.marked,f.from,c.from,e),c.from=f.from),f.to>c.to&&(S(a,b,d,c.marked,c.to,f.to,e),c.to=f.to))})}function T(a,b,c,d,e,f){var g=c.classLocation;b=a.getLineHandle(b);for(var h=0;h<g.length;h++)d&&a.addLineClass(b,g[h],c.chunk),e&&a.addLineClass(b,g[h],c.start),f&&a.addLineClass(b,g[h],c.end);return b}function S(a,b,c,d,e,f,g){function h(r,x){for(var C=Math.max(e,r),z=Math.min(f,x),A=C;A<z;++A)d.push(T(a,A,g,!0,A==r,A==x-1));r==x&&C==x&&z==x&&(C?d.push(T(a,C-1,g,!1,!1,!0)):d.push(T(a,C,g,!1,!0,!1)))}for(var k=y(0,0),l=y(e,0),m=a.clipPos(y(f-1)),p=c==DIFF_DELETE?g.del:g.insert,v=0,q=!1,w=0;w<b.length;++w){var t=b[w],n=t[0];t=t[1];n==DIFF_EQUAL?(n=k.line+(ca(b,w)?0:1),L(k,t),t=k.line+(da(b,w)?1:0),t>n&&(q&&(h(v,n),q=!1),v=t)):(q=!0,n==c&&(n=L(k,t,!0),k=0<(l.line-k.line||l.ch-k.ch)?l:k,t=0>(m.line-n.line||m.ch-n.ch)?m:n,k.line==t.line&&k.ch==t.ch||d.push(a.markText(k,t,{className:p})),k=n))}q&&h(v,k.line+1)}function D(a){if(a.showDifferences){if(a.svg){K(a.svg);var b=a.gap.offsetWidth;ea(a.svg,"width",b,"height",a.gap.offsetHeight)}a.copyButtons&&K(a.copyButtons);var c=a.edit.getViewport(),d=a.orig.getViewport(),e=a.mv.wrap.getBoundingClientRect().top,f=e-a.edit.getScrollerElement().getBoundingClientRect().top+a.edit.getScrollInfo().top;e=e-a.orig.getScrollerElement().getBoundingClientRect().top+a.orig.getScrollInfo().top;for(var g=0;g<a.chunks.length;g++){var h=a.chunks[g];if(h.editFrom<=c.to&&h.editTo>=c.from&&h.origFrom<=d.to&&h.origTo>=d.from){var k=a,l=e,m=f,p=b,v="left"==k.type,q=k.orig.heightAtLine(h.origFrom,"local",!0)-l;if(k.svg){var w=q,t=k.edit.heightAtLine(h.editFrom,"local",!0)-m;if(v){var n=w;w=t;t=n}l=k.orig.heightAtLine(h.origTo,"local",!0)-l;var r=k.edit.heightAtLine(h.editTo,"local",!0)-m;v&&(n=l,l=r,r=n);v=" C "+p/2+" "+t+" "+p/2+" "+w+" "+(p+2)+" "+w;w=" C "+p/2+" "+l+" "+p/2+" "+r+" -1 "+r;ea(k.svg.appendChild(document.createElementNS("http://www.w3.org/2000/svg","path")),"d","M -1 "+t+v+" L "+(p+2)+" "+l+w+" z","class",k.classes.connect)}k.copyButtons&&(p=k.copyButtons.appendChild(B("div","left"==k.type?"\u21dd":"\u21dc","CodeMirror-merge-copy")),t=k.mv.options.allowEditingOriginals,p.title=k.edit.phrase(t?"Push to left":"Revert chunk"),p.chunk=h,p.style.top=(h.origTo>h.origFrom?q:k.edit.heightAtLine(h.editFrom,"local")-m)+"px",p.setAttribute("role","button"),p.setAttribute("tabindex","0"),p.setAttribute("aria-label",p.title),t&&(m=k.edit.heightAtLine(h.editFrom,"local")-m,q=k.copyButtons.appendChild(B("div","right"==k.type?"\u21dd":"\u21dc","CodeMirror-merge-copy-reverse")),q.title="Push to right",q.chunk={editFrom:h.origFrom,editTo:h.origTo,origFrom:h.editFrom,origTo:h.editTo},q.style.top=m+"px","right"==k.type?q.style.left="2px":q.style.right="2px",q.setAttribute("role","button"),q.setAttribute("tabindex","0"),q.setAttribute("aria-label",q.title)))}}}}function fa(a,b){for(var c=0,d=0,e=0;e<b.length;e++){var f=b[e];if(f.editTo>a&&f.editFrom<=a)return null;if(f.editFrom>a)break;c=f.editTo;d=f.origTo}return d+(a-c)}function U(a,b,c){var d=a.state.trackAlignable;a=a.firstLine();for(var e=0,f=[],g=0;;g++){for(var h=b[g],k=h?c?h.origFrom:h.editFrom:1E9;e<d.alignable.length;e+=2){var l=d.alignable[e]+1;if(!(l<=a))if(l<=k)f.push(l);else break}if(!h)break;f.push(a=c?h.origTo:h.editTo)}return f}function ha(a,b,c,d){var e=0,f=0,g=0,h=0;a:for(;;e++){var k=a[e],l=b[f];if(!k&&null==l)break;var m=k?k[0]:1E9;for(l=null==l?1E9:l;g<c.length;){var p=c[g];if(p.origFrom<=l&&p.origTo>l){f++;e--;continue a}if(p.editTo>m){if(p.editFrom<=m)continue a;break}h+=p.origTo-p.origFrom-(p.editTo-p.editFrom);g++}m==l-h?(k[d]=l,f++):m<l-h?k[d]=m+h:(k=[l-h,null,null],k[d]=l,a.splice(e,0,k),f++)}}function ra(a,b){var c=U(a.edit,a.chunks,!1),d=[];if(b)for(var e=0,f=0;e<b.chunks.length;e++){for(var g=b.chunks[e].editTo;f<c.length&&c[f]<g;)f++;f!=c.length&&c[f]==g||c.splice(f++,0,g)}for(e=0;e<c.length;e++)d.push([c[e],null,null]);ha(d,U(a.orig,a.chunks,!0),a.chunks,1);b&&ha(d,U(b.orig,b.chunks,!0),b.chunks,2);return d}function Q(a,b){if(a.dealigned||b){if(!a.orig.curOp)return a.orig.operation(function(){Q(a,b)});a.dealigned=!1;var c=a.mv.left==a?a.mv.right:a.mv.left;c&&(F(c),c.dealigned=!1);for(var d=ra(a,c),e=a.mv.aligners,f=0;f<e.length;f++)e[f].clear();e.length=0;var g=[a.edit,a.orig],h=[],k=[];c&&g.push(c.orig);for(f=0;f<g.length;f++)h.push(g[f].getScrollInfo().top),k.push(-g[f].getScrollerElement().getBoundingClientRect().top);(k[0]!=k[1]||3==g.length&&k[1]!=k[2])&&ia(g,k,[0,0,0],e);for(c=0;c<d.length;c++)ia(g,k,d[c],e);for(f=0;f<g.length;f++)g[f].scrollTo(null,h[f])}}function ia(a,b,c,d){for(var e=-1E8,f=[],g=0;g<a.length;g++)if(null!=c[g]){var h=a[g].heightAtLine(c[g],"local")-b[g];f[g]=h;e=Math.max(e,h)}for(g=0;g<a.length;g++)if(null!=c[g]){var k=e-f[g];if(1<k){b=d;h=b.push;var l=a[g];var m=c[g],p=!0;m>l.lastLine()&&(m--,p=!1);var v=document.createElement("div");v.className="CodeMirror-merge-spacer";v.style.height=k+"px";v.style.minWidth="1px";l=l.addLineWidget(m,v,{height:k,above:p,mergeSpacer:!0,handleMouseEvents:!0});h.call(b,l)}}}function ja(a,b,c,d){if(!a.diffOutOfDate){var e=d.origTo>c.lastLine()?y(d.origFrom-1):y(d.origFrom,0),f=y(d.origTo,0),g=d.editTo>b.lastLine()?y(d.editFrom-1):y(d.editFrom,0);d=y(d.editTo,0);var h=a.mv.options.revertChunk;h?h(a.mv,c,e,f,b,g,d):b.replaceRange(c.getRange(e,f),g,d)}}function ka(a){var b=a.lockButton=B("div",null,"CodeMirror-merge-scrolllock");b.setAttribute("role","button");b.setAttribute("tabindex","0");var c=B("div",[b],"CodeMirror-merge-scrolllock-wrap");u.on(b,"click",function(){R(a,!a.lockScroll)});u.on(b,"keyup",function(e){"Enter"===e.key&&R(a,!a.lockScroll)});b=[c];if(!1!==a.mv.options.revertButtons){a.copyButtons=B("div",null,"CodeMirror-merge-copybuttons-"+a.type);var d=function(e){e=e.target||e.srcElement;e.chunk&&("CodeMirror-merge-copy-reverse"==e.className?ja(a,a.orig,a.edit,e.chunk):ja(a,a.edit,a.orig,e.chunk))};u.on(a.copyButtons,"click",d);u.on(a.copyButtons,"keyup",function(e){"Enter"===e.key&&d(e)});b.unshift(a.copyButtons)}"align"!=a.mv.options.connect&&((c=document.createElementNS&&document.createElementNS("http://www.w3.org/2000/svg","svg"))&&!c.createSVGRect&&(c=null),(a.svg=c)&&b.push(c));return a.gap=B("div",b,"CodeMirror-merge-gap")}function la(a){return"string"==typeof a?a:a.getValue()}function Y(a,b,c){V||(V=new diff_match_patch);a=V.diff_main(a,b);for(b=0;b<a.length;++b){var d=a[b];(c?/[^ \t]/.test(d[1]):d[1])?b&&a[b-1][0]==d[0]&&(a.splice(b--,1),a[b][1]+=d[1]):a.splice(b--,1)}return a}function Z(a){var b=[];if(!a.length)return b;for(var c=0,d=0,e=y(0,0),f=y(0,0),g=0;g<a.length;++g){var h=a[g],k=h[0];if(k==DIFF_EQUAL){var l=!ca(a,g)||e.line<c||f.line<d?1:0;k=e.line+l;l=f.line+l;L(e,h[1],null,f);var m=da(a,g)?1:0;h=e.line+m;m=f.line+m;h>k&&(g&&b.push({origFrom:d,origTo:l,editFrom:c,editTo:k}),c=h,d=m)}else L(k==DIFF_INSERT?e:f,h[1])}(c<=e.line||d<=f.line)&&b.push({origFrom:d,origTo:f.line+1,editFrom:c,editTo:e.line+1});return b}function da(a,b){if(b==a.length-1)return!0;var c=a[b+1][1];if(1==c.length&&b<a.length-2||10!=c.charCodeAt(0))return!1;if(b==a.length-2)return!0;c=a[b+2][1];return(1<c.length||b==a.length-3)&&10==c.charCodeAt(0)}function ca(a,b){if(0==b)return!0;var c=a[b-1][1];if(10!=c.charCodeAt(c.length-1))return!1;if(1==b)return!0;c=a[b-2][1];return 10==c.charCodeAt(c.length-1)}function sa(a,b,c){function d(){f.clear();a.removeLineClass(b,"wrap","CodeMirror-merge-collapsed-line")}a.addLineClass(b,"wrap","CodeMirror-merge-collapsed-line");var e=document.createElement("span");e.className="CodeMirror-merge-collapsed-widget";e.title=a.phrase("Identical text collapsed. Click to expand.");var f=a.markText(y(b,0),y(c-1),{inclusiveLeft:!0,inclusiveRight:!0,replacedWith:e,clearOnEnter:!0});f.explicitlyCleared&&d();u.on(e,"click",d);f.on("clear",d);u.on(e,"click",d);return{mark:f,clear:d}}function ta(a,b){function c(){for(var g=0;g<d.length;g++)d[g].clear()}for(var d=[],e=0;e<b.length;e++){var f=b[e];f=sa(f.cm,f.line,f.line+a);d.push(f);f.mark.on("clear",c)}return d[0].mark}function ma(a,b,c,d){for(var e=0;e<a.chunks.length;e++)for(var f=a.chunks[e],g=f.editFrom-b;g<f.editTo+b;g++){var h=g+c;0<=h&&h<d.length&&(d[h]=!1)}}function B(a,b,c,d){a=document.createElement(a);c&&(a.className=c);d&&(a.style.cssText=d);if("string"==typeof b)a.appendChild(document.createTextNode(b));else if(b)for(c=0;c<b.length;++c)a.appendChild(b[c]);return a}function K(a){for(var b=a.childNodes.length;0<b;--b)a.removeChild(a.firstChild)}function ea(a){for(var b=1;b<arguments.length;b+=2)a.setAttribute(arguments[b],arguments[b+1])}function W(a,b){b||(b={});for(var c in a)a.hasOwnProperty(c)&&(b[c]=a[c]);return b}function L(a,b,c,d){a=c?y(a.line,a.ch):a;for(c=0;;){var e=b.indexOf("\n",c);if(-1==e)break;++a.line;d&&++d.line;c=e+1}a.ch=(c?0:a.ch)+(b.length-c);d&&(d.ch=(c?0:d.ch)+(b.length-c));return a}function X(a){this.cm=a;this.alignable=[];this.height=a.doc.height;var b=this;a.on("markerAdded",function(c,d){if(d.collapsed){var e=d.find(1);null!=e&&b.set(e.line,M)}});a.on("markerCleared",function(c,d,e,f){null!=f&&d.collapsed&&b.check(f,M,b.hasMarker)});a.on("markerChanged",this.signal.bind(this));a.on("lineWidgetAdded",function(c,d,e){d.mergeSpacer||(d.above?b.set(e-1,E):b.set(e,na))});a.on("lineWidgetCleared",function(c,d,e){d.mergeSpacer||(d.above?b.check(e-1,E,b.hasWidgetBelow):b.check(e,na,b.hasWidget))});a.on("lineWidgetChanged",this.signal.bind(this));a.on("change",function(c,d){var e=d.from.line,f=d.to.line-d.from.line,g=d.text.length-1,h=e+g;(f||g)&&b.map(e,f,g);b.check(h,M,b.hasMarker);(f||g)&&b.check(d.from.line,M,b.hasMarker)});a.on("viewportChange",function(){b.cm.doc.height!=b.height&&b.signal()})}function oa(a,b){var c=null,d=a.state.diffViews,e=a.getCursor().line;if(d)for(var f=0;f<d.length;f++){var g=d[f],h=a==g.orig;F(g);if(0>b)a:{g=g.chunks;for(var k=g.length-1;0<=k;k--){var l=g[k];l=(h?l.origTo:l.editTo)-1;if(l<e){h=l;break a}}h=void 0}else a:{g=g.chunks;for(k=0;k<g.length;k++)if(l=g[k],l=h?l.origFrom:l.editFrom,l>e){h=l;break a}h=void 0}null!=h&&(null==c||(0>b?h>c:h<c))&&(c=h)}if(null!=c)a.setCursor(c,0);else return u.Pass}var y=u.Pos;I.prototype={constructor:I,init:function(a,b,c){this.edit=this.mv.edit;(this.edit.state.diffViews||(this.edit.state.diffViews=[])).push(this);this.orig=u(a,W({value:b,readOnly:!this.mv.options.allowEditingOriginals},W(c)));"align"==this.mv.options.connect&&(this.edit.state.trackAlignable||(this.edit.state.trackAlignable=new X(this.edit)),this.orig.state.trackAlignable=new X(this.orig));this.lockButton.title=this.edit.phrase("Toggle locked scrolling");this.lockButton.setAttribute("aria-label",this.lockButton.title);this.orig.state.diffViews=[this];a=c.chunkClassLocation||"background";"[object Array]"!=Object.prototype.toString.call(a)&&(a=[a]);this.classes.classLocation=a;this.diff=Y(la(b),la(c.value),this.mv.options.ignoreWhitespace);this.chunks=Z(this.diff);this.diffOutOfDate=this.dealigned=!1;this.needsScrollSync=null;this.showDifferences=!1!==c.showDifferences},registerEvents:function(a){this.forceUpdate=pa(this);R(this,!0,!1);qa(this,a)},setShowDifferences:function(a){a=!1!==a;a!=this.showDifferences&&(this.showDifferences=a,this.forceUpdate("full"))}};var J=!1,N=u.MergeView=function(a,b){if(!(this instanceof N))return new N(a,b);this.options=b;var c=b.origLeft,d=null==b.origRight?b.orig:b.origRight,e=null!=c,f=null!=d,g=1+(e?1:0)+(f?1:0),h=[],k=this.left=null,l=this.right=null,m=this;if(e){k=this.left=new I(this,"left");var p=B("div",null,"CodeMirror-merge-pane CodeMirror-merge-left");h.push(p);h.push(ka(k))}e=B("div",null,"CodeMirror-merge-pane CodeMirror-merge-editor");h.push(e);if(f){l=this.right=new I(this,"right");h.push(ka(l));var v=B("div",null,"CodeMirror-merge-pane CodeMirror-merge-right");h.push(v)}(f?v:e).className+=" CodeMirror-merge-pane-rightmost";h.push(B("div",null,null,"height: 0; clear: both;"));var q=this.wrap=a.appendChild(B("div",h,"CodeMirror-merge CodeMirror-merge-"+g+"pane"));this.edit=u(e,W(b));k&&k.init(p,c,b);l&&l.init(v,d,b);b.collapseIdentical&&this.editor().operation(function(){var n=b.collapseIdentical;"number"!=typeof n&&(n=2);for(var r=[],x=m.editor(),C=x.firstLine(),z=C,A=x.lastLine();z<=A;z++)r.push(!0);m.left&&ma(m.left,n,C,r);m.right&&ma(m.right,n,C,r);for(z=0;z<r.length;z++)if(r[z]){A=z+C;for(var O=1;z<r.length-1&&r[z+1];z++,O++);if(O>n){var H=[{line:A,cm:x}];m.left&&H.push({line:fa(A,m.left.chunks),cm:m.left.orig});m.right&&H.push({line:fa(A,m.right.chunks),cm:m.right.orig});H=ta(O,H);if(m.options.onCollapse)m.options.onCollapse(m,A,O,H)}}});"align"==b.connect&&(this.aligners=[],Q(this.left||this.right,!0));k&&k.registerEvents(l);l&&l.registerEvents(k);var w=function(){k&&D(k);l&&D(l)};u.on(window,"resize",w);var t=setInterval(function(){for(var n=q.parentNode;n&&n!=document.body;n=n.parentNode);n||(clearInterval(t),u.off(window,"resize",w))},5E3)};N.prototype={constructor:N,editor:function(){return this.edit},rightOriginal:function(){return this.right&&this.right.orig},leftOriginal:function(){return this.left&&this.left.orig},setShowDifferences:function(a){this.right&&this.right.setShowDifferences(a);this.left&&this.left.setShowDifferences(a)},rightChunks:function(){if(this.right)return F(this.right),this.right.chunks},leftChunks:function(){if(this.left)return F(this.left),this.left.chunks}};var V,na=1,E=2,M=4;X.prototype={signal:function(){u.signal(this,"realign");this.height=this.cm.doc.height},set:function(a,b){for(var c=-1;c<this.alignable.length;c+=2){var d=this.alignable[c]-a;if(0==d){if((this.alignable[c+1]&b)==b)return;this.alignable[c+1]|=b;this.signal();return}if(0<d)break}this.signal();this.alignable.splice(c,0,a,b)},find:function(a){for(var b=0;b<this.alignable.length;b+=2)if(this.alignable[b]==a)return b;return-1},check:function(a,b,c){var d=this.find(a);-1!=d&&this.alignable[d+1]&b&&!c.call(this,a)&&(this.signal(),(a=this.alignable[d+1]&~b)?this.alignable[d+1]=a:this.alignable.splice(d,2))},hasMarker:function(a){a=this.cm.getLineHandle(a);if(a.markedSpans)for(var b=0;b<a.markedSpans.length;b++)if(a.markedSpans[b].marker.collapsed&&null!=a.markedSpans[b].to)return!0;return!1},hasWidget:function(a){a=this.cm.getLineHandle(a);if(a.widgets)for(var b=0;b<a.widgets.length;b++)if(!a.widgets[b].above&&!a.widgets[b].mergeSpacer)return!0;return!1},hasWidgetBelow:function(a){if(a==this.cm.lastLine())return!1;a=this.cm.getLineHandle(a+1);if(a.widgets)for(var b=0;b<a.widgets.length;b++)if(a.widgets[b].above&&!a.widgets[b].mergeSpacer)return!0;return!1},map:function(a,b,c){for(var d=c-b,e=a+b,f=b=-1,g=0;g<this.alignable.length;g+=2){var h=this.alignable[g];h==a&&this.alignable[g+1]&E&&(b=g);h==e&&this.alignable[g+1]&E&&(f=g);h<=a||(h<e?this.alignable.splice(g--,2):this.alignable[g]+=d)}-1<b&&(d=this.alignable[b+1],d==E?this.alignable.splice(b,2):this.alignable[b+1]=d&~E);-1<f&&c&&this.set(a+c,E)}};u.commands.goNextDiff=function(a){return oa(a,1)};u.commands.goPrevDiff=function(a){return oa(a,-1)}});
...
// button effects
$(function () {var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.createTemplateTagFirstArg=function(a){return a.raw=a};$jscomp.createTemplateTagFirstArgWithRaw=function(a,b){a.raw=b;return a};var button=document.getElementById("submit"),canvas=document.getElementById("canvas");if(null!=button&&null!=canvas){var Sequin=function(){this.color=colors[Math.floor(randomRange(0,colors.length))].back;this.radius=randomRange(1,2);this.position={x:randomRange(canvas.width/2-button.offsetWidth/3,canvas.width/2+button.offsetWidth/3),y:randomRange(canvas.height/2+button.offsetHeight/2+8,canvas.height/2+1.5*button.offsetHeight-8)};this.velocity={x:randomRange(-6,6),y:randomRange(-8,-12)}},Confetto=function(){this.randomModifier=randomRange(0,99);this.color=colors[Math.floor(randomRange(0,colors.length))];this.dimensions={x:randomRange(5,9),y:randomRange(8,15)};this.position={x:randomRange(canvas.width/2-button.offsetWidth/4,canvas.width/2+button.offsetWidth/4),y:randomRange(canvas.height/2+button.offsetHeight/2+8,canvas.height/2+1.5*button.offsetHeight-8)};this.rotation=randomRange(0,2*Math.PI);this.scale={x:1,y:1};this.velocity=initConfettoVelocity([-9,9],[6,11])},disabled=!1,confettiCount=20,sequinCount=10,gravityConfetti=.3,gravitySequins=.55,dragConfetti=.075,dragSequins=.02,terminalVelocity=3,ctx=canvas.getContext("2d");canvas.width=window.innerWidth;canvas.height=window.innerHeight;var cx=ctx.canvas.width/2,cy=ctx.canvas.height/2,confetti=[],sequins=[],colors=[{front:"#7b5cff",back:"#6245e0"},{front:"#b3c7ff",back:"#8fa5e5"},{front:"#5c86ff",back:"#345dd1"}];randomRange=function(a,b){return Math.random()*(b-a)+a};initConfettoVelocity=function(a,b){var d=randomRange(a[0],a[1]),c=b[1]-b[0]+1;c=b[1]-Math.abs(randomRange(0,c)+randomRange(0,c)-c);c>=b[1]-1&&(c+=.25>Math.random()?randomRange(1,3):0);return{x:d,y:-c}};Confetto.prototype.update=function(){this.velocity.x-=this.velocity.x*dragConfetti;this.velocity.y=Math.min(this.velocity.y+gravityConfetti,terminalVelocity);this.velocity.x+=.5<Math.random()?Math.random():-Math.random();this.position.x+=this.velocity.x;this.position.y+=this.velocity.y;this.scale.y=Math.cos(.09*(this.position.y+this.randomModifier))};Sequin.prototype.update=function(){this.velocity.x-=this.velocity.x*dragSequins;this.velocity.y+=gravitySequins;this.position.x+=this.velocity.x;this.position.y+=this.velocity.y};initBurst=function(){for(var a=0;a<confettiCount;a++)confetti.push(new Confetto);for(a=0;a<sequinCount;a++)sequins.push(new Sequin)};render=function(){ctx.clearRect(0,0,canvas.width,canvas.height);confetti.forEach(function(a,b){var d=a.dimensions.x*a.scale.x,c=a.dimensions.y*a.scale.y;ctx.translate(a.position.x,a.position.y);ctx.rotate(a.rotation);a.update();ctx.fillStyle=0<a.scale.y?a.color.front:a.color.back;ctx.fillRect(-d/2,-c/2,d,c);ctx.setTransform(1,0,0,1,0,0);0>a.velocity.y&&ctx.clearRect(canvas.width/2-button.offsetWidth/2,canvas.height/2+button.offsetHeight/2,button.offsetWidth,button.offsetHeight)});sequins.forEach(function(a,b){ctx.translate(a.position.x,a.position.y);a.update();ctx.fillStyle=a.color;ctx.beginPath();ctx.arc(0,0,a.radius,0,2*Math.PI);ctx.fill();ctx.setTransform(1,0,0,1,0,0);0>a.velocity.y&&ctx.clearRect(canvas.width/2-button.offsetWidth/2,canvas.height/2+button.offsetHeight/2,button.offsetWidth,button.offsetHeight)});confetti.forEach(function(a,b){a.position.y>=canvas.height&&confetti.splice(b,1)});sequins.forEach(function(a,b){a.position.y>=canvas.height&&sequins.splice(b,1)});window.requestAnimationFrame(render)};button.addEventListener("click",function(a){disabled||(disabled=!0,button.classList.add("loading"),button.classList.remove("ready"),setTimeout(function(){button.classList.add("complete");button.classList.remove("loading");setTimeout(function(){window.initBurst();setTimeout(function(){disabled=!1;button.classList.add("ready");button.classList.remove("complete")},4E3)},320)},300))});resizeCanvas=function(){canvas.width=window.innerWidth;canvas.height=window.innerHeight;cx=ctx.canvas.width/2;cy=ctx.canvas.height/2};window.addEventListener("resize",function(){resizeCanvas()});textElements=button.querySelectorAll(".button-text");textElements.forEach(function(a){characters=a.innerText.split("");var b="";characters.forEach(function(d,c){b+='<span class="char'+c+'" style="--d:'+30*c+"ms; --dr:"+30*(characters.length-c-1)+'ms;">'+d+"</span>"});a.innerHTML=b});render()};});
